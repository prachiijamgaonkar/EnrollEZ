...
import com.example.admissionexamform.model.modelExamPage2;
...
public class Exam_Page2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ExamPage2 =  inflater.inflate(R.layout.fragment_exam__page2, container, false);
        ...
        one_Examination = ExamPage2.findViewById(R.id.etex_one_Examination);
        one_CreditEarned = ExamPage2.findViewById(R.id.etex_one_CreditEarned);
        one_SGPA = ExamPage2.findViewById(R.id.etex_one_SGPA);
        spione_Result = ExamPage2.findViewById(R.id.spiex_one_Result);
        two_Examination = ExamPage2.findViewById(R.id.etex_two_Examination);
        two_CreditEarned = ExamPage2.findViewById(R.id.etex_two_CreditEarned);
        two_SGPA = ExamPage2.findViewById(R.id.etex_two_SGPA);
        spitwo_Result = ExamPage2.findViewById(R.id.spiex_two_Result);
        three_Examination = ExamPage2.findViewById(R.id.etex_three_Examination);
        three_CreditEarned = ExamPage2.findViewById(R.id.etex_three_CreditEarned);
        three_SGPA = ExamPage2.findViewById(R.id.etex_three_SGPA);
        spithree_Result = ExamPage2.findViewById(R.id.spiex_three_Result);
        four_Examination = ExamPage2.findViewById(R.id.etex_four_Examination);
        four_CreditEarned = ExamPage2.findViewById(R.id.etex_four_CreditEarned);
        four_SGPA = ExamPage2.findViewById(R.id.etex_four_SGPA);
        spifour_Result = ExamPage2.findViewById(R.id.spiex_four_Result);
        five_Examination = ExamPage2.findViewById(R.id.etex_five_Examination);
        five_CreditEarned = ExamPage2.findViewById(R.id.etex_five_CreditEarned);
        five_SGPA = ExamPage2.findViewById(R.id.etex_five_SGPA);
        spifive_Result = ExamPage2.findViewById(R.id.spiex_five_Result);
        six_Examination = ExamPage2.findViewById(R.id.etex_six_Examination);
        six_CreditEarned = ExamPage2.findViewById(R.id.etex_six_CreditEarned);
        six_SGPA = ExamPage2.findViewById(R.id.etex_six_SGPA);
        spisix_Result = ExamPage2.findViewById(R.id.spiex_six_Result);
        seven_Examination = ExamPage2.findViewById(R.id.etex_seven_Examination);
        seven_CreditEarned = ExamPage2.findViewById(R.id.etex_seven_CreditEarned);
        seven_SGPA = ExamPage2.findViewById(R.id.etex_seven_SGPA);
        spiseven_Result = ExamPage2.findViewById(R.id.spiex_seven_Result);
        page2_date = ExamPage2.findViewById(R.id.tvexpage2_date);
        iagree1 = ExamPage2.findViewById(R.id.cbex_iagree1);
        Submit2 = ExamPage2.findViewById(R.id.btnex_Submit2);
        SelectImage1 = ExamPage2.findViewById(R.id.btnex_SelectImage1);
        UploadImage1 = ExamPage2.findViewById(R.id.btnex_UploadImage1);
        SelectImage2 = ExamPage2.findViewById(R.id.btnex_SelectImage2);
        UploadImage2 = ExamPage2.findViewById(R.id.btnex_UploadImage2);
        Sign1 = ExamPage2.findViewById(R.id.ivex_Sign1);
        Sign2 = ExamPage2.findViewById(R.id.ivex_Sign2);
        ...
        if (isNetworkAvailable(getContext())) {
            ...
            UploadImage1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(selectedImageUri1 != null && !selectedImageUri1.equals(Uri.EMPTY)){
                        ...
                        storageReference.child("Exam_Form").child(AppClass.getUserNo() + "/StudentSign")
            ...
            UploadImage2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(selectedImageUri2 != null && !selectedImageUri2.equals(Uri.EMPTY)){
                        ...
                        storageReference.child("Exam_Form").child(AppClass.getUserNo() + "/ParentSign")
            ...
            Submit2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(isValidate()) {
                        if (isNetworkAvailable(getContext())) {
                            modelExamPage2 modelAdd = new modelExamPage2();
...
//                }
                ...
                showErrorDialog_fragment(getContext(), "Exam Form", "Please! Select Date");
                return false;
            }
        }else{
            showErrorDialog_fragment(getContext(), "Exam Form", "Please! Click I Agree on Undertaking");
            return false;
        }
